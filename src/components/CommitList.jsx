...
import { fetchCommits, filterCommits, updateField } from '../actions/actions';
...
export default connect(mapStateToProps, { fetchCommits, filterCommits, updateField }) (CommitList)
